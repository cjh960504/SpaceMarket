...
<script>
	function saleStop(id) {
		$.ajax({
  			url:"/market/product/updateState",
  			type:"get",
  			data:{
  				product_id:id
  			},
							...
							<%for(Product product : thisMember.getProductList()) {%>
								<tr id="<%=product.getProduct_id() %>">
									...
									<td class="product-details">
										...
										<span ><strong>Status</strong> <i  <%if(product.getProductState().getProduct_state_id()==1){%>class="before"<% }else{ %>class="after"<%} %>><%=product.getProductState().getState()%></i></span>
									...
									<td class="action" data-title="Action">
										<div class="">
											<ul class="list-inline justify-content-center">
												...
												<%if(member.getMember_id()==thisMember.getMember_id()){ %>
												<li class="list-inline-item" >
													<a data-toggle="tooltip" data-placement="top" title="판매완료처리" class="edit"  href="javascript:saleStop(<%=product.getProduct_id()%>)">
